...
?>
	<h1 id="h1_report">PORTFOLIOS AT RISK REPORT</h1>
	<div id="form_report">
	<form class="form-horizontal" role="form" action="portfoliopdf.php" method="post">
<!-- 	  <div class="form-group">
		    <label class="control-label col-sm-3" for="period">As of </label>
		    <div class="col-sm-4">
