...
<div class="table-responsive" id="div_tables">
	<table class="table" id="expected_table">
		...
		if (isset($_GET['client'])){
            ...
            $sql3 = "SELECT DATE_FORMAT(c.date_of_release, '%b-%d-%y') AS dr, c.loan_amount, c.weekly_interest_rate, c.payment_period, (c.loan_amount*c.weekly_interest_rate*c.payment_period*0.01) intBal, (c.loan_amount+(c.loan_amount*c.weekly_interest_rate*c.payment_period*0.01)) totalBal FROM cases c WHERE c.client_id=$local_id;";
